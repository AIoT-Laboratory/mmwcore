...
| Archive completed ADC | python examples/adc_archive.py adc.bin adc.mmwa --frame-bytes 1572864 --capture-contract-sha256 SHA256 |
| Capture-bound archive reader | use `ADCArchiveFrameReader()` with a `RadarCaptureSpec` and source SHA-256 |
